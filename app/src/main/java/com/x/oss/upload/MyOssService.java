...
import com.aliyun.oss.ossdemo.ProgressInputStream;
...
public class MyOssService {
    ...
    private MyMultiPartUploadManager multiPartUploadManager;
    ...
    public MyOssService(OSS oss, String bucket) {
        this.oss = oss;
        this.bucket = bucket;
        this.multiPartUploadManager = new MyMultiPartUploadManager(oss, bucket, partSize);
    }
...
//                UIDisplayer.displayInfo(info);
    ...
    public PauseableUploadTask asyncMultiPartUpload(String object, String localFile, ExecutorService limitTaskExcutor) {
        if (object.equals("")) {
        ...
        PauseableUploadTask task = multiPartUploadManager.asyncUpload(object, localFile,limitTaskExcutor);
        return task;
    }
